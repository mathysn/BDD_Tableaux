...
CREATE TABLE tableau(
    ...
    CONSTRAINT tableau_fk FOREIGN KEY (type_epoque_id) REFERENCES type_epoque(id_type_epoque) ON DELETE CASCADE,
...
VALUES (NULL, 'La Joconde', 4000, '1506-10-21', 'Léonard de Vinci', 'Louvre', 'laJoconde.jpeg', NULL, 1),
       ...
       (NULL, 'Retable de l\'Agneau mystique', 1010,'1432-01-05', 'Jan van Eyck', 'Cathédrale Saint-Bavon de Gand', 'AgneauMystique.jpeg', NULL, 4);
